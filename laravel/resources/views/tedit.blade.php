...
<div class="view-box" id="view-box">
    <div class="showview-box" id="showview-box">修改意见</div>
    <div class="cont">
        <form action="" method="post" class="form-view">
            <div class="view-box" id="view-box">
                <div class="showview-box" id="showview-box">点评意见</div>
                <div class="cont">
                    <ul>
                        <li><span>教育经历点评：</span><?php  echo  $suggrow[0]->dpjyjl;?></li>
                        <li><span>工作实习经历点评：</span><?php  echo  $suggrow[0]->dpgzsxjl;?></li>
                        <li><span>IT技能点评：</span><?php  echo  $suggrow[0]->dpitjn;?></li>
                        <li><span>语言能力点评：</span><?php  echo  $suggrow[0]->dpyynl;?></li>
                        <li><span>其他情况点评：</span><?php  echo  $suggrow[0]->dpother;?></li>
                        <li><span>家庭背景点评：</span><?php  echo  $suggrow[0]->dpjtbj;?></li>
                        <li><span>报名信息点评：</span><?php  echo  $suggrow[0]->dpbmxx;?></li>
                    </ul>
                    <div class="view-btn"><div class="fr btn" id="closeview-box" >收起点评</div><div class="clear"></div></div>
                </div>
            </div>

            <div class="fr btn" id="closeview-box" >收起点评</div><div class="clear"></div>
    </form>
</div>
</div>
